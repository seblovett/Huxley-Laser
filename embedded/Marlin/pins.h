...
#define HEATER_2_PIN       -1
#ifdef REPRAPPRO_HUXLEY
  #define HEATER_BED_PIN    -1// 10 // bed (change to 10 for gate pin of MOSFET on heated bed)
#else
  #define HEATER_BED_PIN     12
#endif
#define X_ENABLE_PIN       14
...
#define TEMP_1_PIN         -1
#define TEMP_2_PIN         -1
#define TEMP_BED_PIN        -1//6   // MUST USE ANALOG INPUT NUMBERING NOT DIGITAL OUTPUT NUMBERING!!!!!!!!! (pin 34 bed)
#define SDPOWER            -1
#define SDSS               31
