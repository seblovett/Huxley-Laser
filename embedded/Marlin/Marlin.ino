...
void process_commands()
{
  ...
  else if(code_seen('M'))
  {
    ...
    case 558: // Send interrupt
      ...
      break;    
#endif
    case 600: //Laser power on
      // WRITE(HEATER_0_PIN,HIGH);
      st_synchronize();
      WRITE(LASER_ENABLE_PIN,1);
      break;

    case 601: //Laser power off
    st_synchronize();
      WRITE(LASER_ENABLE_PIN,0);
...
// transform destination *********************************************
  ...
  plan_buffer_line(modified_destination[X_AXIS], modified_destination[Y_AXIS], modified_destination[Z_AXIS], modified_destination[E_AXIS], feedrate/60, active_extruder); 
...
// transform destination *********************************************
  ...
  // Trace the arc
  mc_arc(current_position, modified_destination, offset, X_AXIS, Y_AXIS, Z_AXIS, feedrate/60, r, isclockwise, active_extruder);
